...
export const integrationDetails: Record<string, IntegrationDetail> = {
  ...
  'claude-ai': {
    ...
    name: 'Claude AI',
    slug: 'claude-ai',
    description: 'AI-powered assistant for clinical documentation and patient support.',
    enabled: true,
    config: [
      {
        key: 'apiEndpoint',
        ...
        options: [
          { label: 'Production (api.anthropic.com)', value: 'https://api.anthropic.com' },
      ...
      },
      {
        ...
        options: [
          { label: 'Claude Opus 4.5 (Most Capable)', value: 'claude-opus-4-5-20250514' },
          { label: 'Claude Sonnet 4.5 (Balanced)', value: 'claude-sonnet-4-5-20250514' },
          { label: 'Claude 3.5 Sonnet (Fast)', value: 'claude-3-5-sonnet-20241022' },
          { label: 'Claude 3.5 Haiku (Fastest)', value: 'claude-3-5-haiku-20241022' },
        ],
      },
      {
        key: 'maxTokens',
      ...
      },
      {
        ...
        type: 'textarea',
        value: 'You are a helpful clinical assistant. Provide accurate, evidence-based information. Always recommend human review for treatment decisions. Use professional, empathetic tone.',
    ...
    config: [
      {
        ...
        options: [
          { label: 'Production (api.openai.com)', value: 'https://api.openai.com/v1' },
    ...
    config: [
      {
        ...
        options: [
          { label: 'Production (Google AI)', value: 'https://generativelanguage.googleapis.com' },
